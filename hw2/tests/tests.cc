...
void small_file_test3(const string& file, unsigned int item_count)
{
    ...
    REQUIRE( DS.count() == 0 );
    ReadFile( file, DS );
    WHEN("Haetaan jokaista tiedostossa olevaa ID:t yksi kerrallaan")
    {
...
SCENARIO( "Pieni varasto. Poistetaan koko varastosaldo, lisätään uudestaan ja tarkistetaan.", "[PIENI][ST6]" )
{
    GIVEN("Luetaan varastotilanne varasto1.txt")
    {
